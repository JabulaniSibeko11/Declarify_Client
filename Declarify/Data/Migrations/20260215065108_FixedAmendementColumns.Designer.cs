...
namespace Declarify.Data.Migrations
{
    ...
    [Migration("20260215065108_FixedAmendementColumns")]
    partial class FixedAmendementColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Declarify.Models.FormSubmission", b =>
                {
                    ...
                    b.Property<int?>("AmendmentOfSubmissionId")
                        .HasColumnType("int");

                    b.Property<int?>("AssignedManagerId")
                        .HasColumnType("int");

                    b.Property<string>("AssignedManagerName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("AmendmentOfSubmissionId");
            ...
            modelBuilder.Entity("Declarify.Models.FormSubmission", b =>
                {
                    b.HasOne("Declarify.Models.FormSubmission", "AmendsSubmission")
                        .WithMany()
                        .HasForeignKey("AmendmentOfSubmissionId")
